...
void tvdff_fast(Eigen::Ref<Eigen::MatrixXd> &f, const Eigen::Ref<Eigen::MatrixX4i> &ind_derivatives, Eigen::Ref<Eigen::MatrixXd> out, unsigned long int width, double lmd, double tol=1e-2, unsigned long int iters=100);
